...
const profile = () => {
  ...
  return (
    ...
    >
      ...
      <View className='flex felx-col mt-10'>
        <SettingsItem icon={icons.calendar} title="My Bookings"></SettingsItem>
        <SettingsItem icon={icons.calendar} title="My Events"></SettingsItem>
      </View>
      ...
      <View className='flex flex-col mt-5 border-t pt-5 border-primary-200'>
        <SettingsItem icon={icons.logout} title="Logout" textStyle='text-danger' showArrow={false} onPress={handleLogout}></SettingsItem>
        
      </View>
      <Link href="/auth/signup" className='text-lg font-nunito text-accent-300'>Sign In</Link>
    </ScrollView>
  </SafeAreaView>
)
}
